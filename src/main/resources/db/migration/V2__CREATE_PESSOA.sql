...
create table pessoa_contacts (pessoa_id bigint not null, contacts_id_contacts bigint not null);
create table contato (id_contacts bigint not null, ds_contato varchar(100) not null, tipo_contato varchar(255) not null, id_pessoa bigint, primary key (id_contacts));
